...
export default function Learn(props) {
  const { getFlashcards, flashcardState, handleFlashcardSearch, flashcards } =
  ...
  return (
    <div>
      <h3 className="title-learn-page">Learn About Women in STEM!</h3>
      ...
      <div className="learn-container">
        ...
        <div className="searchbar-flashcards">
          <SearchBarCards handleFlashcardSearch={handleFlashcardSearch} />
        </div>
      </div>
